var store = [{
        ...
        "excerpt":"문제 설명 숫자로 이루어진 문자열 t와 p가 주어질 때, t에서 p와 길이가 같은 부분문자열 중에서, 이 부분문자열이 나타내는 수가 p가 나타내는 수보다 작거나 같은 것이 나오는 횟수를 return하는 함수 solution을 완성하세요. 예를 들어, t=”3141592”이고 p=”271” 인 경우, t의 길이가 3인 부분 문자열은 314, 141, 415, 159, 592입니다. 이 문자열이 나타내는...","categories": ["Algorithm"],
        ...
        "excerpt":"문제 설명 명함 지갑을 만드는 회사에서 지갑의 크기를 정하려고 합니다. 다양한 모양과 크기의 명함들을 모두 수납할 수 있으면서, 작아서 들고 다니기 편한 지갑을 만들어야 합니다. 이러한 요건을 만족하는 지갑을 만들기 위해 디자인팀은 모든 명함의 가로 길이와 세로 길이를 조사했습니다. 아래 표는 4가지 명함의 가로 길이와 세로 길이를 나타냅니다. 명함 번호...","categories": ["Algorithm"],
        ...
        "excerpt":"데일리 스크럼 알고리즘 함수형 프로그래밍과 클로저, 고차함수를 생각하면서 무작정 for문을 쓰지 않으려고 신경써서 풀었다. 정렬은 sort 함수로 썼는데 너무 편하고 좋더라. 무작정 푸는게 아니라 생각해보고 풀어야겠다. 타입캐스팅 팀원들하고 타입캐스팅 관련해서 어려운 점을 이야기하고 각자 공부해서 이야기하는 시간으로 도움이 많이 됐던 것 같다. 심화 강의 심화 강의는 절반 정도 봤는데 전부...","categories": ["TIL"],
        "tags": ["TIL"],
        "url": "/TIL/til11/",
        "teaser": null
      },{
        ...
        "excerpt":"데일리 스크럼 알고리즘 지난 금요일, 오늘 47번에서 생각 중인데 내일 오전에는 꼭 한문제 풀어야겠다. 앱 개발 입문 강의 전체 2시간이면 볼 수 있는데 따라해보면서 포스팅한다고 3시간 좀 넘게 봤던 것 같다. 내일 남은 강의 마저 볼 예정. 강의가 짧아서 실습이 중요하다는 걸 느낀다.. 내일 목표 알고리즘 문제 풀기 강의 완강...","categories": ["TIL"],
        "tags": ["TIL"],
        "url": "/TIL/til15/",
        "teaser": null
      },{
        ...
        "excerpt":"문제 설명 문자열로 구성된 리스트 strings와, 정수 n이 주어졌을 때, 각 문자열의 인덱스 n번째 글자를 기준으로 오름차순 정렬하려 합니다. 예를 들어 strings가 [“sun”, “bed”, “car”]이고 n이 1이면 각 단어의 인덱스 1의 문자 “u”, “e”, “a”로 strings를 정렬합니다. 문제 풀기 제한사항 strings는 길이 1 이상, 50이하인 배열입니다. strings의 원소는 소문자 알파벳으로...","categories": ["Algorithm"],
        ...
        "excerpt":"데일리 스크럼 알고리즘 오늘 47번 문제를 푸는데 가장 오래 걸렸다. 문자열 관련 처리, swift에서 제공하는 함수에 아직도 익숙하지 못한 것 같다. 문자열 자르고 배열 만들어 추가하고… 갖은 방법을 동원하다가 sorted 클로저로 풀 수 있었다. 풀이 보기 문자열 내 마음대로 정렬하기 앱 개발 입문 강의 앱 개발 입문강의를 완강하고 간단한 카운터...","categories": ["TIL"],
        "tags": ["TIL"],
        "url": "/TIL/til16/",
        "teaser": null
      },{
        ...
        "excerpt":"문제 설명 문자열 s가 주어졌을 때, s의 각 위치마다 자신보다 앞에 나왔으면서, 자신과 가장 가까운 곳에 있는 같은 글자가 어디 있는지 알고 싶습니다. 예를 들어, s=”banana”라고 할 때, 각 글자들을 왼쪽부터 오른쪽으로 읽어 나가면서 다음과 같이 진행할 수 있습니다. b는 처음 나왔기 때문에 자신의 앞에 같은 글자가 없습니다. 이는 -1로...","categories": ["Algorithm"],
        ...
        "excerpt":"문제 설명 2016년 1월 1일은 금요일입니다. 2016년 a월 b일은 무슨 요일일까요? 두 수 a ,b를 입력받아 2016년 a월 b일이 무슨 요일인지 리턴하는 함수, solution을 완성하세요. 요일의 이름은 일요일부터 토요일까지 각각 SUN,MON,TUE,WED,THU,FRI,SAT 입니다. 예를 들어 a=5, b=24라면 5월 24일은 화요일이므로 문자열 “TUE”를 반환하세요. 문제 풀기 제한사항 2016년은 윤년입니다. 2016년 a월 b일은...","categories": ["Algorithm"],
